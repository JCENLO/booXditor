...
export default (domc, editor) => {
    ...
    //             el &&
    //             el.classList &&
    //             el.classList.contains("card-img-overlay")
    //         ) {
    ...
    //             el &&
    //             el.classList &&
    //             el.classList.contains("card-img-bottom")
    //         ) {
